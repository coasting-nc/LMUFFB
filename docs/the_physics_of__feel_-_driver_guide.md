...
![Understeer Visualization 1](telemetry_visualizations/understeer.jpg "Plot A (FFB Output): Final FFB Signal showing a drop in amplitude despite increased steering. Plot B (Input): Steering Angle increasing. Plot C (Physics): Front Tire Grip Fraction dropping from 1.0 to < 0.8. Plot D (Physics): Lateral G-Force plateauing or dropping.")

![Understeer Visualization 2](telemetry_visualizations/understeer2.jpg "Additional understeer telemetry visualization showing the relationship between steering input, grip fraction, and FFB output.")
...
![Oversteer Visualization 1](telemetry_visualizations/oversteer.jpg "Plot A (FFB Output): SoP/Oversteer Force Component spiking. Plot B (Physics): Lateral G-Force high amplitude. Plot C (Physics): Grip Delta (Front Grip minus Rear Grip). Plot D (Input): Steering Angle showing the driver counter-steering in response.")

![Oversteer Visualization 2](telemetry_visualizations/oversteer2.jpg "Additional oversteer telemetry visualization showing SoP effect and rear grip loss dynamics.")
...
![Brake Lockup Visualization 1](telemetry_visualizations/brake_lockup.jpg "Plot A (FFB Output): Lockup Rumble Signal showing frequency change. Plot B (Input): Brake Pedal Position at 100%. Plot C (Physics): Wheel Slip Ratio dropping below -0.1. Plot D (Physics): Car Speed decreasing, correlating with the changing frequency in Plot A.")

![Brake Lockup Visualization 2](telemetry_visualizations/brake_lockup2.jpg "Additional brake lockup telemetry visualization showing the relationship between speed, slip ratio, and vibration frequency.")
...
![Traction Loss Visualization 1](telemetry_visualizations/traction_loss_power_wheelspin.jpg "Plot A (FFB Output): Total Force showing a sudden drop/notch plus Vibration overlay. Plot B (Input): Throttle Position at 100%. Plot C (Physics): Rear Wheel Slip Ratio spiking > 0.2. Plot D (Physics): Slip Speed (m/s) correlating with vibration pitch.")

![Traction Loss Visualization 2](telemetry_visualizations/traction_loss_power_wheelspin2.jpg "Additional traction loss telemetry visualization showing torque drop and vibration dynamics during wheel spin.")
...
![Slide Texture Visualization 1](telemetry_visualizations/slide_lateral_scrubbing.jpg "Plot A (FFB Output): Slide Texture Signal with Sawtooth waveform. Plot B (Physics): Lateral Patch Velocity (m/s). Plot C (Physics): Tire Slip Angle (rad). Plot D (Physics): Vertical Tire Load modulating the amplitude.")

![Slide Texture Visualization 2](telemetry_visualizations/slide_lateral_scrubbing2.jpg "Additional slide texture telemetry visualization showing lateral scrubbing dynamics and tire load effects.")
...
![Power Slide Visualization 1](telemetry_visualizations/power_slide_spin_vs_sop.jpg "Plot A (FFB Output): Total Force showing vector direction (SoP) but chopped amplitude (Spin). Plot B (Physics): Lateral G High, driving the SoP. Plot C (Physics): Rear Slip Ratio High, driving the Torque Drop. Plot D (Physics): Yaw Rate showing the car rotation.")

![Power Slide Visualization 2](telemetry_visualizations/power_slide_spin_vs_sop2.jpg "Additional power slide telemetry visualization showing the interaction between Spin effect and SoP effect.")
...
![Trail Braking Visualization 1](telemetry_visualizations/trail_braking_load_transfer_vs_understeer.jpg "Plot A (FFB Output): Total Force showing rising peak, then sudden drop-off. Plot B (Physics): Front Tire Load spiking due to weight transfer. Plot C (Physics): Front Grip Fraction dropping as tires saturate. Plot D (Input): Brake Pressure vs Steering Angle.")

![Trail Braking Visualization 2](telemetry_visualizations/trail_braking_load_transfer_vs_understeer2.jpg "Additional trail braking telemetry visualization showing the interaction between load transfer and understeer effect.")
...
![Tank Slapper Visualization 1](telemetry_visualizations/tank_slapper_snap_oversteer.jpg "Plot A (FFB Output): Total Force showing the violent reversal/spike. Plot B (Physics): Rear Slip Ratio dropping from High to Zero. Plot C (Physics): Lateral G crossing zero rapidly. Plot D (Physics): Steering Arm Force showing the raw game physics aligning torque returning.")

![Tank Slapper Visualization 2](telemetry_visualizations/tank_slapper_snap_oversteer2.jpg "Additional tank slapper telemetry visualization showing snap oversteer recovery dynamics.")