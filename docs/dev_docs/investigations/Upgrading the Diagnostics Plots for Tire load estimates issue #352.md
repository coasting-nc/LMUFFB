...
This new layout will give you a perfect side-by-side comparison of all 4 wheels overlaid, prove that the Dynamic Ratio is matching perfectly, and restore the statistical charts you liked from the previous version.
