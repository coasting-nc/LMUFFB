...
5.  **In-Game Force Feedback settings in LMU**:
    *   In-game Force Feedback MUST be **Enabled**.
    *   Set **FFB Strength to 100%** in LMU settings for maximum dynamic range. You should then adjust the overall FFB strength using the **Master Gain** or **In-Game FFB Gain** sliders within the lmuFFB app.
    *   It is necessary to have it enabled (and greater than zero) if you want to use the option to also transmit the in-game FFB through the lmuFFB app.
