...
[list]
[*][b]Fixed Inverted Lateral Load (#321)[/b]: Corrected a logic error where the lateral load effect was pulling the wheel in the wrong direction. The force now correctly correlates with physical load transfer, providing a natural and progressive resistance.
[*][b]Smooth Feel[/b]: Fixing the inversion also resolved the reported "notchiness" at high loads. The transition across center and through maximum load is now buttery smooth.
[/list]
...
[b]New release[/b] (0.7.120): https://github.com/coasting-nc/LMUFFB/releases

[list]
[*][b]Reduced Console Noise[/b]: Removed non-essential "ResizeBuffers" logs and periodic telemetry rate dumps from the console. These details remain available in the GUI diagnostics but no longer clutter your session logs.
[*][b]Smarter Health Warnings[/b]: Improved the "Low Sample Rate detected" system. Warnings now appear every 60 seconds instead of every 5 seconds, and duplicate console messages have been removed, ensuring you are informed of performance issues without being spammed. (#238)
[/list]
...
[b]Fixed[/b]
[list]
[*][b]Linux/Steam Deck Stability[/b]: Resolved a memory leak in the Linux compatibility layer that caused the automated sanitizer checks to report a false positive. This does not affect functionality on any platform but ensures our CI quality gates remain clean.
[/list]
...
[b]Improved[/b]
[list]
[*][b]General[/b]: Finalized strict code analysis fixes to ensure maximum compatibility with modern compilers on both Windows and Linux.
[*][b]Stability[/b]: Resolved potential initialization edge cases in the main application loop.
[/list]
...
[b]Improved[/b]
[list]
[*][b]Code Health[/b]: Hardened the application's global exception handlers to ensure more reliable diagnostic reporting during crashes.
[*][b]Testing[/b]: Modernized internal test code to meet strictly defined security and safety standards.
[/list]
...
[size=5][b]February 27, 2026[/b][/size]
[b]Version 0.7.97 - Math Precision and UI Polish[/b]

[b]New release[/b] (0.7.97): https://github.com/coasting-nc/LMUFFB/releases

[b]Improved[/b]
[list]
[*][b]GUI[/b]: Refined numerical rounding throughout the interface for consistent value displays.
[*][b]Stability[/b]: Modernized internal mathematical calculations to prevent precision edge cases.
[/list]
...
[size=5][b]February 27, 2026[/b][/size]
[b]Version 0.7.96 - Internal Optimization[/b]

[b]New release[/b] (0.7.96): https://github.com/coasting-nc/LMUFFB/releases

[b]Improved[/b]
[list]
[*][b]Backend[/b]: Optimized internal pointer handling and architectural compatibility in the test infrastructure.
[/list]
...
[b]Improved[/b]
[list]
[*][b]Developer Experience[/b]: Silenced several more low-priority compiler warnings in testing architectures to keep the console focused purely on high-priority build issues.
[/list]
...
[b]Improved[/b]
[list]
[*][b]Cleaner Application Build[/b]: Further optimized code analysis systems to filter out distracting stylistic compilation warnings, letting us focus on higher quality code and features.
[/list]
