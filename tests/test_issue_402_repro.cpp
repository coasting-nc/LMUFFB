...
TEST_CASE(test_road_texture_time_domain_independence, "Texture") {
    ...
    data.mWheel[WHEEL_FL].mTireLoad = 4500.0;
    data.mWheel[WHEEL_FR].mTireLoad = 4500.0;
    data.mWheel[WHEEL_RL].mTireLoad = 4500.0;
    data.mWheel[WHEEL_RR].mTireLoad = 4500.0;
    ...
    for(int i=0; i<100; i++) {
        data.mWheel[WHEEL_FL].mVerticalTireDeflection += susp_velocity * 0.01;
        data.mWheel[WHEEL_FR].mVerticalTireDeflection += susp_velocity * 0.01;
    ...
    // Pump 1 second of simulation to stabilize EMA
    for(int i=0; i<400; i++) {
        data.mWheel[WHEEL_FL].mVerticalTireDeflection += susp_velocity * 0.0025;
        data.mWheel[WHEEL_FR].mVerticalTireDeflection += susp_velocity * 0.0025;
