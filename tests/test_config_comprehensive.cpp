...
TEST_CASE(test_config_comprehensive_import, "Config") {
    ...
    const char* test_file = "tmp_comprehensive_import.ini";
    {
        ...
        file << "slope_detection.enabled=1\n";
        file << "slope_detection.sg_window=17\n";
        file << "slope_detection.sensitivity=0.85\n";
        file << "slope_negative_threshold=0.1\n";
        file << "slope_detection.smoothing_tau=0.06\n";
        file << "slope_detection.min_threshold=0.05\n";
        file << "slope_detection.max_threshold=0.95\n";
        file << "slope_detection.alpha_threshold=0.03\n";
        file << "slope_detection.decay_rate=0.4\n";
        file << "slope_detection.confidence_enabled=1\n";
        ...
        file << "slope_detection.g_slew_limit=5.0\n";
        file << "slope_detection.use_torque=1\n";
        file << "slope_detection.torque_sensitivity=0.6\n";
        file << "slope_detection.confidence_max_rate=0.15\n";
        file.close();
    }
    ...
    ASSERT_NEAR(imported.front_axle.understeer_effect, 0.6f, 0.01);
    ASSERT_EQ(imported.braking.lockup_enabled, true);
