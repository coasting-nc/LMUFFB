...
TEST_CASE(test_gui_style_application, "Logic") {
    ...
    LMUFFB::GUI::GuiLayer::SetupGUIStyle();
...
TEST_CASE(test_defaults_consistency, "Logic") {
    ...
    // Test 2: Verify FFBEngine initialization matches
    {
        ...
        ASSERT_TRUE(engine.m_advanced.gyro_gain == reference_defaults.advanced.gyro_gain);
        ...
        ASSERT_TRUE(engine.m_advanced.gyro_smoothing == reference_defaults.advanced.gyro_smoothing);
    ...
    // Test 3: Default preset from LoadPresets()
    {
        ...
        ASSERT_TRUE(default_preset.advanced.gyro_gain == reference_defaults.advanced.gyro_gain);
        ...
        ASSERT_TRUE(default_preset.advanced.gyro_smoothing == reference_defaults.advanced.gyro_smoothing);
    ...
    // Test 5: Preset application consistency
    {
        ...
        ASSERT_TRUE(engine1.m_advanced.gyro_gain == engine2.m_advanced.gyro_gain);
        ...
        ASSERT_TRUE(engine1.m_advanced.gyro_smoothing == engine2.m_advanced.gyro_smoothing);
