...
TEST_CASE(test_linux_mock_error_branches, "System") {
    ...
    // NOTE: do NOT erase the map entry here. LMUFFB::IO::GameConnector::TryConnect() stores a raw
...
TEST_CASE(test_preset_equals_branches, "System") {
    ...
    TEST_FIELD_NE(grip_estimation.slip_angle_smoothing, 0.5f);
    ...
    TEST_FIELD_NE(grip_estimation.grip_smoothing_steady, 0.5f);
    TEST_FIELD_NE(grip_estimation.grip_smoothing_fast, 0.5f);
    TEST_FIELD_NE(grip_estimation.grip_smoothing_sensitivity, 0.5f);
    TEST_FIELD_NE(braking.lockup_enabled, !p2.braking.lockup_enabled);
    TEST_FIELD_NE(braking.lockup_gain, 0.5f);
    TEST_FIELD_NE(braking.lockup_start_pct, 0.5f);
    TEST_FIELD_NE(braking.lockup_full_pct, 0.5f);
    TEST_FIELD_NE(braking.lockup_rear_boost, 0.5f);
    TEST_FIELD_NE(braking.lockup_gamma, 0.5f);
    TEST_FIELD_NE(braking.lockup_prediction_sens, 0.5f);
    TEST_FIELD_NE(braking.lockup_bump_reject, 0.5f);
    TEST_FIELD_NE(braking.brake_load_cap, 0.5f);
    TEST_FIELD_NE(vibration.texture_load_cap, 0.5f);
    TEST_FIELD_NE(braking.abs_pulse_enabled, !p2.braking.abs_pulse_enabled);
    TEST_FIELD_NE(braking.abs_gain, 0.5f);
    TEST_FIELD_NE(braking.abs_freq, 0.5f);
    TEST_FIELD_NE(vibration.spin_enabled, !p2.vibration.spin_enabled);
    TEST_FIELD_NE(vibration.spin_gain, 0.5f);
    TEST_FIELD_NE(vibration.spin_freq_scale, 0.5f);
    TEST_FIELD_NE(vibration.slide_enabled, !p2.vibration.slide_enabled);
    TEST_FIELD_NE(vibration.slide_gain, 0.5f);
    ...
    TEST_FIELD_NE(vibration.bottoming_method, 1);
