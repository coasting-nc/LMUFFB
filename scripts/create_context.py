...
EXCLUDE_DIRS = {
    'build', 'build_gcc', 'build_mingw', 'build_test', 'build_tests', 'build-tests', 'build_ninja', 'build_ninja_test', 'build_ninja_test_with_ex', 'build_ninja_user_exact', 'build_ninja_verify', 'build_ninja_verify_final', 'build_repro', 'build_repro_fixed', 'build_verification', '.git', 'python_prototype', 'vendor', '__pycache__', '.vscode', '.specstory', '.pytest_cache'
}
